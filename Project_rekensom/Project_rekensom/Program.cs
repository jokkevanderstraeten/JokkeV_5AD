...
_vermenigvuldig = (_vermeerderd * _vermenigvuldiging);

//Deel het getal door 2 en sla op
_delen = (_vermenigvuldig / _deling);
//scherm leegmaken
Console.Clear();
...
Console.WriteLine($"Uw gaf getallen {_getal1} en {_getal2} in." +
    ...
    $"\r\nDaarna werd er vermenigvuldig met 10. Dit gaf als uitkomst {_vermenigvuldig}" +
    $"\r\nAls laatste werd er gedeeld door 2. " +
    $"\r\nHet uiteindelijke resultaat is {_delen}\r\n");
